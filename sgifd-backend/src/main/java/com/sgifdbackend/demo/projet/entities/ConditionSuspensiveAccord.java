...
@Entity
@Table(name = "t_ConditionSuspensiveAccord")
public class ConditionSuspensiveAccord extends EntityBaseBean implements Serializable {
    ...
    public ConditionSuspensiveAccord() {
    }
	...
	public String toString() {
		return "ConditionSuspensiveAccord [id=" + id + ", libelle=" + libelle + "]";
	}
