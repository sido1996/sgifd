...
@Component({
  selector: 'app-tb-aide-secours',
  templateUrl: './tb-aide-secours.component.html',
  styleUrls: ['./tb-aide-secours.component.css']
})
export class TbAideSecoursComponent implements OnInit {
  ...
  doGraph(
    ...
    if (optionGraph == 0) {
      ...
      options = {
       ...
       title: {
         text:
           "Evolution de l' <b> aide </b> par " + value + " <b>(" + total + " aides)</b>",
         style: {
           fontSize: "13px",
         },
       },
