...
@Component({
  selector: 'app-list-cooperation',
  templateUrl: './list-cooperation.component.html',
  styleUrls: ['./list-cooperation.component.css']
})
export class ListCooperationComponent implements OnInit {
  ...
  ouvrirModifier(id: number): void {
    this.router.navigate(['admin/cooperation-decentralisee/modifier-cooperation/' + id]);
  }

  ouvrirDetail(id: number): void {
    this.router.navigate(['admin/cooperation-decentralisee/detail-cooperation/' + id]);
  }
