...
@Component({
  selector: 'app-modifier-cooperation',
  templateUrl: './modifier-cooperation.component.html',
  styleUrls: ['./modifier-cooperation.component.css']
})
export class ModifierCooperationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cooperationDecentraliseeService.getById(this.paramKey).subscribe(
      (data: CooperationDecentralisee) => {
        ...
        this.makeFormCooperation();
        this.initFormInformateur(this.informateur);
  ...
  initFormInformateur(informateur: Informateur) {
    this.validateFormInformateur = this.fb.group({
      ...
      [Validators.required]],
      sourceInformation: [this.informateur != null && this.informateur.sourceInformation != null ? this.informateur.sourceInformation.id : null,
      [Validators.required,]],
    });
    this.informateur = informateur;
  }
