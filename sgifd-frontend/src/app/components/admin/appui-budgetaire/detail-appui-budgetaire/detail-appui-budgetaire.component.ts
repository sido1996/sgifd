...
@Component({
  selector: 'app-detail-appui-budgetaire',
  templateUrl: './detail-appui-budgetaire.component.html',
  styleUrls: ['./detail-appui-budgetaire.component.css']
})
export class DetailAppuiBudgetaireComponent implements OnInit {
  paramKey: number;
