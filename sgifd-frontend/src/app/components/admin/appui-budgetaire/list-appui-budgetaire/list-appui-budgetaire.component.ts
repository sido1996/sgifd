...
@Component({
  selector: 'app-list-appui-budgetaire',
  templateUrl: './list-appui-budgetaire.component.html',
  styleUrls: ['./list-appui-budgetaire.component.css']
})
export class ListAppuiBudgetaireComponent implements OnInit {
  ...
  ouvrirModifier(id: number): void {
    this.router.navigate(['admin/appui-budgetaire/modifier-appui-budgetaire/' + id]);
  }

  ouvrirDetail(id: number): void {
    this.router.navigate(['admin/appui-budgetaire/detail-appui-budgetaire/' + id]);
  }
