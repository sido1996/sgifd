...
@Component({
  selector: 'app-modifier-appui-budgetaire',
  templateUrl: './modifier-appui-budgetaire.component.html',
  styleUrls: ['./modifier-appui-budgetaire.component.css']
})
export class ModifierAppuiBudgetaireComponent implements OnInit {
  ...
  submitForm(): void {
    if (this.validateForm.valid == true) {
      ...
      this.appuiBudgetaireSubmit = formData.montant;
      this.appuiBudgetaireSubmit = formData.observation;
