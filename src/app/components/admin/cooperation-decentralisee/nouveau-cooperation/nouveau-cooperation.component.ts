...
@Component({
  selector: 'app-nouveau-cooperation',
  templateUrl: './nouveau-cooperation.component.html',
  styleUrls: ['./nouveau-cooperation.component.css']
})
export class NouveauCooperationComponent implements OnInit {
  ...
  enregistrerCooperation(): void {
    if (this.validateFormInformateur.valid === true) {
      ...
      if (this.informateur == null) {
        ...
        //this.informateur.sourceInformation = formData.sourceInformation;
  ...
  initFormInformateur(informateur: Informateur) {
    this.validateFormInformateur = this.fb.group({
      ...
      [Validators.required]],
      sourceInformation: [(informateur != null) ? informateur.sourceInformation.id : null,
      [Validators.required]],
    });
    this.informateur = informateur;
  }
