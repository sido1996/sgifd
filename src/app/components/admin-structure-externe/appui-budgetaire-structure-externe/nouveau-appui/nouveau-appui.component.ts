...
@Component({
  selector: 'app-nouveau-appui',
  templateUrl: './nouveau-appui.component.html',
  styleUrls: ['./nouveau-appui.component.css']
})
export class NouveauAppuiComponent implements OnInit {
